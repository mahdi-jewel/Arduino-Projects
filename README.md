...
#LED blinking 0.2 Description:
 After delay of 1000ms of execution of the program LED1 will ON and 1000ms after it turns to OFF.then after 1000ms the LED1 and LED2 will ON together then again turns OFF after 1000ms.For every 1000ms delay number of ON-light are increasing and also OFF on the next second.
