...
#LED blinking 0.2 Description:
   turns to OFF.then after 1000ms the LED1 and LED2 will ON together then again turns OFF after 1000ms.For every 1000ms delay number of ON-light are increasing and also OFF on the next second.
